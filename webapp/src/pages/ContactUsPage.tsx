            ...
            <Card style={{
                ...
                <CardContent>
                    ...
                    <Typography variant='subtitle1' align='center'>
                        Please join our <a href="https://discord.gg/qGvkkd3eTM" target="_blank" rel="noreferrer">Discord Server</a>, we would love to get in touch
                    </Typography>
                    <List>
                        <ListItem>
                            <ListItemIcon>
                        ...
                        <ListItem>
                            ...
                            <ListItemText primary={<a color='white' href="https://discord.gg/qGvkkd3eTM" target="_blank" rel="noreferrer">Discord Server</a>}/>
                        </ListItem>
                    </List>
                </CardContent>
            </Card>
