...
const DashboardWidget = (props: Props) => {
    ...
    return (
        ...
        >
            <CardContent>
                <Grid2 container spacing={2} display={'flex'} flexDirection={'row'} alignItems={'center'}>
                    <Grid2 xs={9}>
                        <Typography sx={{fontSize: '1.5rem', fontWeight: 'bold', margin: '8px 0'}}>
                            {props.value}
                        </Typography>
                        <Typography sx={{fontSize: '1rem', color: 'text.secondary',marginBottom: '4px'}} gutterBottom>
                            {props.title}
                        </Typography>
                    ...
                    <Grid2 xs={3} display={'flex'} alignContent={'center'} m={0} p={0}>
                        <Box
                            sx={{
